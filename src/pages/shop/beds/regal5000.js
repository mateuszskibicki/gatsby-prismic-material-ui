        ...
        <SingleBedPage
          ...
          description={
            <>
              ...
              <p className="mb-2 small">
                The luxury engineered spring system features 5000 individually
                encased pocket springs in a 3-tier construction – a 3000 centre
                air suspension core with an additional 2” - 1000 pocket support
                unit on each side to further enhance surface comfort. The
                springs adjust to your body contours and provide anatomically
                correct support with no ‘roll together’. The mattress spring
                unit has strengthened edge support to ensure total comfort and
                support across the entire sleep area.
              </p>
              <p className="mb-2 small">
