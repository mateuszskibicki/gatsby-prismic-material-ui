      ...
      <SingleBedPage
        ...
        description={
          <>
            ...
            <p className="mb-2">
              Deep 100% Natural Latex core with a unique 7-Zone design to ensure
              properly supported sleep across the entire sleep surface
            </p>
            <p className="mb-2">
            ...
            <p className="strong">NO NEED TO TURN</p>
          </>
        }
        overview={
          <>
            ...
            <p className="mb-2">
              6. 100% Natural Latex is a totally renewable raw material. Rubber
              trees neutralize over 90 million tons of carbon dioxide (CO2) each
              year.
            </p>
            <p className="mb-2">7. Meets UK Flammability Regulations.</p>
          </>
        }
      />
      <WarrantyAndBedcare />
