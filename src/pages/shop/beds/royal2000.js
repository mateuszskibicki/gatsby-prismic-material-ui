          ...
          description={
            <>
              ...
              <p className="mb-2 small">
                ...
                encased pocket springs (tiered 2 x 1000) that adjust to your
                body contours and provide anatomically correct support with no
                ‘roll together’. The mattress spring unit has enhanced
