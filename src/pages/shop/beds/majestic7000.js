          ...
          description={
            <>
              ...
              <p className="mb-2 small">
                ...
                air suspension core with an additional 2 x 1000 mini-pocket
                tablet support unit on each side to further enhance surface
                comfort. The springs adjust to your body contours and provide
                anatomically correct support with no ‘roll together’. The
                mattress spring unit has strengthened edge support to ensure
